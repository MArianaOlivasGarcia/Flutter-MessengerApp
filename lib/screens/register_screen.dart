      ...
      child: Column(
        children: [
          CustomInput(
            ...
            onChanged: ( value ) => authFormProvider.name = value
          ),
          ...
          CustomButton(
            ...
            onPressed: authProvider.isAuthenticating ? null : () async {
                ...
                final authResponse = await authProvider.register( authFormProvider.name.trim(), authFormProvider.email.trim(), authFormProvider.password.trim() );
